...
export default function PaymentsDashboard({
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      if (modalMode === "add") {
        await addPayment({ systemId: formSystemId, amount: formAmount, paidAt: formDate, note: formNote });
      } else if (modalMode === "edit" && editingId) {
        await updatePayment(editingId, { amount: formAmount, paidAt: formDate, note: formNote });
      }
